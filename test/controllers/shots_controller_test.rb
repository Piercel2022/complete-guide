...
class ShotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shot" do
    assert_difference("Shot.count") do
      post shots_url, params: { shot: { description: @shot.description, image: @shot.image, title: @shot.title } }
    end
  ...
  test "should update shot" do
    patch shot_url(@shot), params: { shot: { description: @shot.description, image: @shot.image, title: @shot.title } }
